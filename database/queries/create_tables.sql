-- Active: 1761118867313@@127.0.0.1@5432@TaxiDB
...
CREATE TABLE IF NOT EXISTS RideOrder_Rating (
	id SERIAL PRIMARY KEY,
	order_id UUID NOT NULL REFERENCES RideOrder(id),
...
CREATE TABLE IF NOT EXISTS Maintenance (
	id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
	mechanic_id UUID NOT NULL REFERENCES Client(id),
	car_id UUID NOT NULL REFERENCES Car(id),
	maintenance_start TIMESTAMP NOT NULL,
	maintenance_end TIMESTAMP NOT NULL,
	comment VARCHAR(255) NOT NULL
);